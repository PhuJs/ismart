                ...
                <div class="section-detail">
                    <div class="filter-wp clearfix">
                        <ul class="post-status fl-left">
                            <li class="all"><a href="">Số lượng: <span class="count"><?php echo $total_customer; ?></span></a></li>
                        </ul>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <ul class="list-operation fl-right">
                                            <li><a href="?mod=sell&controller=index&action=updateCustomerGp&id=<?php echo $item['order_id'];?>&map=<?php echo $id;?>&pr=3" title="Sửa" class="edit"><i class="fa fa-pencil" aria-hidden="true"></i></a></li>
                                        </ul>
                                    </td>
