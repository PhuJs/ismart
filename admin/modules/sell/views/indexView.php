        ...
        <div id="content" class="fl-right">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <ul class="list-operation fl-right">
                                                    ...
                                                    <li><a href="?mod=sell&controller=index&action=thrownTrash&id=<?php echo $item['order_id']?>&map=<?php echo $id; ?>&ac=1" title="Đưa vào thùng rác" class="delete"><i class="fa fa-trash" aria-hidden="true"></i></a></li>
                                                </ul>
                                            </td>
            ...
            <div class="section" id="paging-wp">
                <div class="section-detail clearfix">
                    ...
                    get_pagging($num_page, "?mod=sell&controller=index&action=index&id=", $id);
                    ?>
                </div>
            </div>
        </div>
