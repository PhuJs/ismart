    ...
    <div class="wrap clearfix">
        ...
        <div id="content" class="fl-right">
            <div class="section" id="title-page">
                <div class="clearfix">
                    <h3 id="index" class="fl-left">Danh sách sách hàng mới</h3>
                </div>
            </div>
                ...
                <div class="section-detail">
                    <div class="filter-wp clearfix">
                        <ul class="post-status fl-left">
                            <li class="all"><a href="">Số lượng: <span class="count"><?php echo count($list_customer); ?></span></a></li>
                        </ul>
                    ...
                    <div class="actions">
                        <form method="GET" action="" class="form-actions">
                            <select name="select_group_customer">
                                ...
                                <option value="2" title="Đã mua hàng trong 10 ngày trở lại và số lượng đơn hàng lớn hơn 1">Khách hàng tiềm năng</option>
                            </select>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <ul class="list-operation fl-right">
                                            <li><a href="?mod=sell&controller=index&action=updateCustomerGp&id=<?php echo $item['order_id'];?>&map=<?php echo $id;?>&pr=4" title="Sửa" class="edit"><i class="fa fa-pencil" aria-hidden="true"></i></a></li>
                                        </ul>
                                    </td>
                                    ...
                                    <td><span class="tbody-text"><?php echo $item['number_of'];?></span></td>
            ...
            <div class="section" id="paging-wp">
                <div class="section-detail clearfix">
                     <?php 
                     // Điều hướng
                    //  get_pagging($num_page, "?mod=sell&controller=index&action=listCustomerNew&id=", $id);
                     ?>
                </div>
            </div>
            <div class="mt-3">
            <a href="?mod=sell&controller=index&action=customerList" title="Trở lại danh sách tất cả khách hàng" class="btn btn-link btn-primary text-white">Trở lại</a>
            </div>
        </div>
    </div>
</div>
