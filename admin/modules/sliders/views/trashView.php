    ...
    <div class="wrap clearfix">
        ...
        <div id="content" class="fl-right">
                                        ...
                                        <tr>
                                            ...
                                            <td class="clearfix">
                                                ...
                                                <ul class="list-operation fl-right">
                                                    <li><a href="?mod=sliders&controller=index&action=delete_slider&id=<?php echo $item['id']; ?>" title="Xóa" class="delete"><i class="fa fa-trash" aria-hidden="true"></i></a></li>
                                                </ul>
                                            </td>
            ...
            <div class="section" id="paging-wp">
                ...
                <a href="?mod=sliders&controller=index&action=index" class="btn btn-info">Trở lại</a>
            </div>
        </div>
    </div>
</div>
