            ...
            ?>
                    ...
                    <div class="section-detail">
                        <div class="filter-wp clearfix">
                            <ul class="post-status fl-left">
                                ...
                                <li class="pending"><a href="?mod=products&controller=index&action=confirm_product">Chờ xét duyệt<span class="count"><?php echo "(". $product_confirm  .")";?></span> |</a></li>
                                <li class="pending"><a href="?mod=products&controller=index&action=out_of_stock">Sản phẩm hết hàng<span class="count"><?php echo "(". $product_empty .")"; ?></span> |</a></li>
                                <li class="pending"><a href="?mod=products&controller=index&action=products_trash">Thùng rác<span class="count"><?php echo "(". $product_trash .")"; ?></span></a></li>
                            </ul>
                                        ...
                                        <tr>
                                            ...
                                            <td class="clearfix">
                                                <div class="tb-title fl-left">
                                                    <a href="?mod=products&controller=index&action=info_product&id=<?php echo $item['product_id']; ?>&map=<?php echo $id; ?>&act=1" title=""><?php echo $item['product_name']; ?></a>
                                                </div>
                                                <ul class="list-operation fl-right">
                                                    <li><a href="?mod=products&controller=index&action=updatePd&id=<?php echo $item['product_id']; ?>&page=<?php echo $id; ?>&act=1" title="Sửa" class="edit"><i class="fa fa-pencil" aria-hidden="true"></i></a></li>
                                                    <li><a href="?mod=products&controller=index&action=addTrash&id=<?php echo $item['product_id']; ?>&page=<?php echo $id?>&act=1" title="Cho vào thùng rác" class="delete"><i class="fa fa-trash" aria-hidden="true"></i></a></li>
                                                </ul>
                                            </td>
                ...
                <div class="section" id="paging-wp">
                    <div class="section-detail clearfix">
                        ...
                        <?php
                        get_pagging($num_page, "?mod=products&controller=index&action=index&id=", $id);
                        ?>
                    </div>
                </div>
            <?php
