    ...
    <div class="wrap clearfix">
        ...
        <div id="content" class="fl-right">
            <div class="section" id="title-page">
                <div class="clearfix">
                    <h3 id="index" class="fl-left">Danh sách kết quả tìm kiếm</h3>
                </div>
            </div>
            <?php
            ...
            ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="clearfix">
                                                <div class="tb-title fl-left">
                                                    <a href="?mod=products&controller=index&action=info_product&id=<?php echo $item['product_id'];?>&key=<?php echo $key; ?>&map=<?php echo $id; ?>&act=5" title=""><?php echo $item['product_name']; ?></a>
                                                </div>
                                                <ul class="list-operation fl-right">
                                                    <li><a href="?mod=products&controller=index&action=updatePd&id=<?php echo $item['product_id']; ?>&key=<?php echo $key; ?>&page=<?php echo $id; ?>&act=2" title="Sửa" class="edit"><i class="fa fa-pencil" aria-hidden="true"></i></a></li>
                                                    <li><a href="?mod=products&controller=index&action=addTrash&id=<?php echo $item['product_id']; ?>&page=<?php echo $id; ?>&key=<?php echo $key; ?>&act=4" title="Chuyển vào thùng rác" class="delete"><i class="fa fa-trash" aria-hidden="true"></i></a></li>
                                                </ul>
                                            </td>
                ...
                <div class="section" id="paging-wp">
                    <div class="section-detail clearfix">
                        ...
                        <?php
                        get_pagging($num_page, "?mod=products&controller=index&action=search&key={$key}&id=", $id);
                        ?>
                    </div>
                    <a href="?mod=products&controller=index&action=index" class="btn btn-primary">Thoát tìm kiếm</a>
                </div>
            <?php
            } else {
