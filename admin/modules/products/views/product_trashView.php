    ...
    <div class="wrap clearfix">
        ...
        <div id="content" class="fl-right">
            <div class="section" id="title-page">
                <div class="clearfix">
                    <h3 id="index" class="fl-left">Danh sách sản phẩm trong thùng rác</h3>
                </div>
            </div>
            <?php
                ...
                <div class="section" id="detail-page">
                    <div class="section-detail">
                        <div class="filter-wp clearfix">
                            <div class="">
                                <p class="h6">Tổng sản phẩm: <span class="text-danger"><?php echo count($list_product);?></span></p>
                            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="clearfix">
                                                <div class="tb-title fl-left">
                                                    <a href="?mod=products&controller=index&action=info_product&id=<?php echo $item['product_id']; ?>&map=<?php echo $id; ?>&act=4" title=""><?php echo $item['product_name']; ?></a>
                                                </div>
                                                <ul class="list-operation fl-right">
                                                    <li><a href="?mod=products&controller=index&action=updatePd&id=<?php echo $item['product_id']; ?>&page=<?php echo $id; ?>&act=5" title="Sửa" class="edit"><i class="fa fa-pencil" aria-hidden="true"></i></a></li>
                                                    <!-- <li><a href="?mod=products&controller=index&action=delete_product&id=<?php echo $item['product_id']; ?>" title="Xóa sản phẩm trong thùng rác" class="delete"><i class="fa fa-trash" aria-hidden="true"></i></a></li> -->
                                                </ul>
                                            </td>
            ...
            ?>
        <a href="?mod=products&controller=index&action=index" class="btn btn-primary fl-right">Trở lại</a>    
        </div>
    </div>
</div>
<?php
