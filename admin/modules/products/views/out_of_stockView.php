                                        ...
                                        <tr>
                                            ...
                                            <td class="clearfix">
                                                <div class="tb-title fl-left">
                                                    <a href="?mod=products&controller=index&action=info_product&id=<?php echo $item['product_id']; ?>&map=<?php echo $id; ?>&act=3" title=""><?php echo $item['product_name']; ?></a>
                                                </div>
                                                <ul class="list-operation fl-right">
                                                    <li><a href="?mod=products&controller=index&action=updatePd&id=<?php echo $item['product_id']; ?>&page=<?php echo $id; ?>&act=4" title="Sửa" class="edit"><i class="fa fa-pencil" aria-hidden="true"></i></a></li>
                                                    <li><a href="?mod=products&controller=index&action=addTrash&id=<?php echo $item['product_id']; ?>&page=<?php echo $id?>&act=3" title="Cho vào thùng rác" class="delete"><i class="fa fa-trash" aria-hidden="true"></i></a></li>
                                                </ul>
                                            </td>
